...
import 'package:gym_app/features/workouts_exercises/presentation/pages/workout_exercise_add_exercise_page.dart';
...
final workoutExercisesRoutes = <GoRoute>[
  ...
  // Add exercise to workout exercise page
  GoRoute(
    path: '/workout-exercise-add-exercise/:workoutId',
    builder: (context, state) {
      final workoutId = state.pathParameters['workoutId'] ?? '';
      ...
      return MultiBlocProvider(
        ...
        child: WorkoutExerciseAddExercisePage(
          workoutId: workoutId,
        ),
      );
    },
